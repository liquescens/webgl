// @ts-check
/**
 * @typedef {Object} WebGL2ProgramAttribute
...
export class WebGL2Program
{
    ...
    {
        let vertex_shader = WebGL2Program.compileShader(gl, vertex_shader_source, gl.VERTEX_SHADER);
        let fragment_shader = WebGL2Program.compileShader(gl, fragment_shader_source, gl.FRAGMENT_SHADER);
    ...
    constructor(context, attributes_model, uniforms_model, vertex_shader_source, fragment_shader_source, transform_feedback_varyings)
    {
        ...
        this.handle = WebGL2Program.compileProgram(context, vertex_shader_source, fragment_shader_source, transform_feedback_varyings);
